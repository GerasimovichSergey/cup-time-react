        ...
        <footer className="footer">
            <div className="container footer__container">
                <a className="footer__logo-link">
                    <img className="footer__logo" src="images/logo.svg" alt="Логотип Cup Time" />
                </a>
                ...
                <div className="footer__info">
                    ...
                    <ul className="footer__developers">
                        ...
                        <li className="footer__developer">Developer: <a href="https://github.com/GerasimovichSergey"
                                                                        className="footer__developer-link">Gerasimovich
                            Sergey</a>
                        </li>
                    </ul>
                </div>
